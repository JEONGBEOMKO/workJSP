select rownum as rn , b.* from bbs b;<%@ page language="java" contentType="text/html; charset=UTF-8"    pageEncoding="UTF-8"%>
<%-- <%@ include file="ssi.jsp" %> --%>

<%@ page import="net.bitcamp.guest.GuestDAO" %>
<%@ page import="net.bitcamp.guest.GuestDTO" %>
<%@ page import="java.util.ArrayList" %>  <!-- 활용해서 데이터 뿌리기 -->
...
/* 	//GuestDTO dto = new GuestDTO();
	for(int i=0; i<LG.size(); i++) {
		GuestDTO dto = (GuestDTO)LG.get(i);  //dto 객체를 형변환해주는게 좋음
